...
from modular_cli.modular_cli_autocomplete import BASH_COMPLETE_SCRIPT, ZSH_COMPLETE_SCRIPT, \
    RELATIVE_PATH_TO_COMPLETE, PROFILE_D_PATH, PROFILE_ZSH_COMPLETE_SCRIPT, \
